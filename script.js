...
//         if(string === 'C'){
//             console.log(`${temperature+57.6} Fahrenhiet`)
//         }else if(string === 'F'){
//             console.log(`${temperature-32} Celsius`)
//         }else{
//             console.log('Wrong scale input')
//         }
//     }
...
//         console.log(`${firstName.slice(0,3)}${lastName.slice(0,3)}12`)
//     }
...
//     function numArgs(num1 , num2 , num3 , num4 , num5){
